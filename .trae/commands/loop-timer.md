...
```json
{
  ...
  "cycle": 1,
  "status": "completed",
  "ts": "2026-07-02T14:05:00Z",
  "duration_ms": 3500,
  "tool_calls": 5,
  "convergence": {
    "status": "effective|stall|regress",
    "no_progress_count": 0,
    "delta": null
  },
  "result_summary": "[LOOP:converge] OK | 有效收敛 | failure_reduction=0%"
}
```

路径：`.trae/loop-state/timer-{loop_id}-cycle-{n}.json`
