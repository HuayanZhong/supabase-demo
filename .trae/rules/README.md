...
| **场景触发**            | `code-style.md`、`document-query.md`、`naming.md`、`review.md`、`git-commit-message.md` | 匹配场景时加载   |
| **领域约束**            | `frontend/*.md`、`backend/*.md`、`devops/*.md`、`quality/*.md`、`shared/*.md`           | 对应领域任务     |
