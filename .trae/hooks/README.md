...
PreToolUse(Write) ─────→ protect-mcp-json.ps1（安全拦截）
  ...
  │                        指向: naming.md + comments.md + frontend/comments.md + frontend/i18n.md + agent-catalog.md（安全约束）
  │
...
| PreToolUse(Write)           | enforce-code-standards.ps1 | 指向规则 | 指向 naming.md + comments.md + frontend/comments.md + frontend/i18n.md + agent-catalog.md | 写代码前       |
...
| frontend/comments.md            | PreToolUse(Write)           | 指针     |
